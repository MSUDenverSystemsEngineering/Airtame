...
Try {
	...
	[string]$appScriptDate = '07/21/2021'
	...
	If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
		...
		Show-InstallationWelcome -CloseApps 'Airtame' -CheckDiskSpace -PersistPrompt
		...
		$exitCode = Execute-MSI -Action 'Install' -Path "$dirFiles\Airtame-4.2.1-setup.msi" -PassThru
		...
		$exitCode = Execute-Process -Path "$envSystem32Directory\netsh.exe" -Parameters "advfirewall firewall add rule name=`"Airtame`" dir=in action=allow program=`"${envProgramFilesX86}\Airtame\Airtame.exe`" enable=yes" -Windows "Hidden" -WaitForMsiExec -PassThru
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		$exitCode = Execute-MSI -Action 'Uninstall' -Path "{9CD66454-71B0-454F-BA14-B4C0A9662091}" -PassThru
		If (($exitCode.ExitCode -ne "0") -and ($mainExitCode -ne "3010")) { $mainExitCode = $exitCode.ExitCode }
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUo1xNH4YC0SyrWZTOeC/JkFC6
# mYSgghHXMIIFbzCCBFegAwIBAgIQSPyTtGBVlI02p8mKidaUFjANBgkqhkiG9w0B
...
# MRYEFMAbBfWgn+FoLPoKBsHh/b9T1nlzMA0GCSqGSIb3DQEBAQUABIIBgFA4z+qU
# +VuEEtaRxRLzgQvvQ/D7PPuCpEpmAfLMR41DlZPtQHhITj0iUo1KHXNWFKUjBRvr
# IEEpGf9Sa9LLjmlLqvvXh9lr9a59xxYrRt36E4db2eesBJ0Hg8kZqp7U8xWKqOcb
# DWRBQk+TGDuBR/jUWxFVki4G4KWV6iJWl1KaQI4Aq0nlhfsz866qRXYd2rvVeGIL
# B+U8HIGOCEYcSUYCEnG80OohQvpegdELEtPsUgIoHzx8NpH6fJtEq+RN1z0tAmoG
# cj/UnowCij9xRhbPmUOD2qEFDUhMHylJLUpwDU6NKfUVZNZFtDC5anMqA6Jjd+27
# x2gS9Gqu89WX4QpjMVOz2ALrLqhwLWTU68qRazyfxrruDliydVox4IUzfH7Ulqs5
# yxRH61uD8Fsv50bLoylTBQUkQE/mIs9TMT9muR0KCxeOjfZywesmB/lOVNS9n/Nc
# FNfKV+M65s6VZBzH/QvUoftU2BD/p0YReF3OvIZuMQkrsfpU5T6ZSUsIiw==
